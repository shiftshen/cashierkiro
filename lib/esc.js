...
var jpPrinter = {
	createNew: function() {
		...
		jpPrinter.setTh = function() {
			//1B 23 23 53 4C 41 4E 20
			//1B 23 23 53 4C 41 4E
			//泰文指令 转10进制发送
			data.push(27)
			data.push(35)
			data.push(35)
			...
			// 1B 23 23 43 44 54 59 02
			//泰文打印编码UTF-8 指令  转10进制发送
			data.push(27)
			data.push(35)
			data.push(35)
			data.push(67)
		...
		jpPrinter.getCommandsHexString = function() { // 获取生成指令的十六进制字符串
