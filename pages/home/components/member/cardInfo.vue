<template>
	<view class="userInfo f-1 f14">
		<uni-table ref="table" border stripe :emptyText="$t('member.value_info')">
			<uni-tr>
				<uni-th align="center">{{$t('member.channel_seedel')}}</uni-th>
				<uni-th align="center">{{$t('member.growth_value_change_seedel')}}</uni-th>
				<uni-th align="center">{{$t('member.current_growth_value_seedel')}}</uni-th>
				<uni-th align="center">{{$t('member.level_change_seedel')}}</uni-th>
				<uni-th align="center">{{$t('member.change_time_seedel')}}</uni-th>
				<uni-th align="center">{{$t('member.remarks_seedel')}}</uni-th>
			</uni-tr>
